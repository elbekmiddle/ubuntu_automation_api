...
export class ApiError extends Error {
    ...
    constructor(body, statusCode) {
        ...
        this.code = body.code;
        this.hint = body.code ? ERROR_CODE_HINTS[body.code] : undefined;
    }
}
...
function toApiError(error) {
    ...
    return new ApiError({ statusCode: 0, message: error.message || 'Network error — server bilan bog\'lanib bo\'lmadi' }, 0);
}
