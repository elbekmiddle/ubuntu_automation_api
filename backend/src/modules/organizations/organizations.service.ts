...
export class OrganizationsService {
  ...
  async findOneForUser(userId: string, id: string) {
    ...
    if (!membership) {
      throw new NotFoundException({
        code: ORG_ERROR_CODES.NOT_FOUND,
        message: ORG_ERRORS[ORG_ERROR_CODES.NOT_FOUND],
      });
    }
  ...
  async updateMemberRole(
    ...
    if (!member) {
      throw new NotFoundException({
        code: ORG_ERROR_CODES.MEMBER_NOT_FOUND,
        message: ORG_ERRORS[ORG_ERROR_CODES.MEMBER_NOT_FOUND],
      });
    }
