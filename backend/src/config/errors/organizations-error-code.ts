...
export const ORG_ERRORS = {
    ...
    [ORG_ERROR_CODES.ALREADY_A_MEMBER]: 'Bu email allaqachon a\'zo (yoki taklif qilingan)',
    [ORG_ERROR_CODES.CANNOT_MODIFY_OWNER]: 'Owner rolini o\'zgartirib yoki uni olib tashlab bo\'lmaydi',
    [ORG_ERROR_CODES.ONLY_OWNER_CAN_DELETE]: 'Faqat owner tashkilotni o\'chira oladi',
} as const;
